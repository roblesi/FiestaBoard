...
> = {
  ...
  flights: {
    ...
    description: "Display nearby aircraft overhead with real-time flight data (call signs, altitude, speed, squawk codes). Free tier: 100 API requests/month.",
    icon: Plane,
    hasRefreshInterval: true,
    defaultRefreshSeconds: 28800, // 8 hours for free tier
    fields: [
      {
        key: "api_key",
        ...
        required: true,
        description: "⚠️ Note: Free tier lacks real-time position data. Shows random active flights instead of nearby aircraft. Upgrade to Basic plan ($9.99/mo) for true nearby flight tracking.",
      },
      {
        key: "latitude",
        label: "Latitude",
        ...
        placeholder: "37.7749",
        required: true,
        description: "Your location latitude for flight monitoring",
      },
      {
        key: "longitude",
        label: "Longitude",
        ...
        placeholder: "-122.4194",
        required: true,
        description: "Your location longitude for flight monitoring",
      },
      {
        key: "radius_km",
        ...
        type: "number",
        placeholder: "50",
        description: "How far to search for flights (default: 50km)",
      },
      {
        key: "max_count",
        label: "Max Flights",
        type: "number",
        placeholder: "4",
        description: "Maximum flights to display (1-4, default: 4)",
      },
      {
        key: "refresh_seconds",
        label: "Refresh Interval (seconds)",
        type: "number",
        placeholder: "28800",
        description: "How often to fetch flight data (28800 = 8 hours, required for free tier 100 req/month limit)",
      },
    ],
    outputs: [
      { name: "call_sign", description: "Aircraft call sign/flight number", example: "UAL123", maxChars: 8, typical: "6-8 chars" },
      { name: "altitude", description: "Current altitude in feet", example: "35000", maxChars: 5, typical: "4-5 digits" },
      { name: "ground_speed", description: "Speed over ground in km/h", example: "450", maxChars: 4, typical: "3-4 digits" },
      { name: "squawk", description: "Transponder squawk code", example: "1234", maxChars: 4, typical: "4 digits" },
      { name: "distance_km", description: "Distance from your location", example: "12.5", maxChars: 4, typical: "2-4 chars" },
      { name: "formatted", description: "Pre-formatted flight line (call sign, alt, speed, squawk)", example: "UAL123   35000  450 1234", maxChars: 22, typical: "22 chars" },
      { name: "flight_count", description: "Total number of nearby flights detected", example: "3", maxChars: 1, typical: "1 digit" },
      { name: "flights.0.call_sign", description: "Closest flight - call sign", example: "UAL123", maxChars: 8, typical: "6-8 chars" },
      { name: "flights.0.altitude", description: "Closest flight - altitude", example: "35000", maxChars: 5, typical: "4-5 digits" },
      { name: "flights.0.ground_speed", description: "Closest flight - ground speed", example: "450", maxChars: 4, typical: "3-4 digits" },
      { name: "flights.0.squawk", description: "Closest flight - squawk code", example: "1234", maxChars: 4, typical: "4 digits" },
      { name: "flights.0.distance_km", description: "Closest flight - distance", example: "12.5", maxChars: 4, typical: "2-4 chars" },
      { name: "flights.0.formatted", description: "Closest flight - pre-formatted line", example: "UAL123   35000  450 1234", maxChars: 22, typical: "22 chars" },
      { name: "flights.1.call_sign", description: "2nd closest flight - call sign", example: "DAL456", maxChars: 8, typical: "6-8 chars" },
      { name: "flights.1.altitude", description: "2nd closest flight - altitude", example: "28000", maxChars: 5, typical: "4-5 digits" },
      { name: "flights.1.formatted", description: "2nd closest flight - pre-formatted line", example: "DAL456   28000  420 7421", maxChars: 22, typical: "22 chars" },
      { name: "flights.2.call_sign", description: "3rd closest flight - call sign", example: "AAL789", maxChars: 8, typical: "6-8 chars" },
      { name: "flights.2.altitude", description: "3rd closest flight - altitude", example: "31000", maxChars: 5, typical: "4-5 digits" },
      { name: "flights.2.formatted", description: "3rd closest flight - pre-formatted line", example: "AAL789   31000  465 5523", maxChars: 22, typical: "22 chars" },
      { name: "flights.3.call_sign", description: "4th closest flight - call sign", example: "SWA012", maxChars: 8, typical: "6-8 chars" },
      { name: "flights.3.altitude", description: "4th closest flight - altitude", example: "33000", maxChars: 5, typical: "4-5 digits" },
      { name: "flights.3.formatted", description: "4th closest flight - pre-formatted line", example: "SWA012   33000  440 2314", maxChars: 22, typical: "22 chars" },
    ],
  },
};
