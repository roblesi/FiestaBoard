...
> = {
  ...
  property: {
    ...
    outputs: [
      ...
      { name: "value_str", description: "Current value string (first property)", example: "$1.25M", maxChars: 8, typical: "6-8 chars" },
      { name: "change_percent", description: "Percentage change (first property)", example: "+2.5%", maxChars: 6, typical: "4-6 chars" },
      { name: "change_str", description: "Change percent string (first property)", example: "+2.5%", maxChars: 6, typical: "4-6 chars" },
      ...
      { name: "total_value", description: "Total value of all properties", example: "$3.2M", maxChars: 10, typical: "6-10 chars" },
      { name: "total_change", description: "Total dollar change across all", example: "+$125K", maxChars: 10, typical: "6-10 chars" },
      { name: "total_change_percent", description: "Average % change across all", example: "+3.2%", maxChars: 6, typical: "4-6 chars" },
      { name: "time_window", description: "Comparison time period", example: "1 Month", maxChars: 10, typical: "6-10 chars" },
      ...
      { name: "properties.0.value_str", description: "Value string of first property", example: "$1.25M", maxChars: 8, typical: "6-8 chars" },
      { name: "properties.0.change_percent", description: "% change of first property", example: "+2.5%", maxChars: 6, typical: "4-6 chars" },
      { name: "properties.0.change_str", description: "Change string of first property", example: "+2.5%", maxChars: 6, typical: "4-6 chars" },
      ...
      { name: "properties.1.change_percent", description: "% change of second property", example: "-1.2%", maxChars: 6, typical: "4-6 chars" },
      { name: "properties.1.formatted", description: "Formatted display of second property", example: "RENTAL{red} $850K -1.2%", maxChars: 22, typical: "15-22 chars" },
      { name: "properties.2.display_name", description: "Name of third property", example: "CABIN", maxChars: 10, typical: "3-10 chars" },
      { name: "properties.2.current_value", description: "Current value of third property", example: "$625K", maxChars: 8, typical: "6-8 chars" },
      { name: "properties.2.change_percent", description: "% change of third property", example: "+0.8%", maxChars: 6, typical: "4-6 chars" },
    ],
  },
};
